...
public class Move {
    public Unit move(GameTiles gameTiles, Unit unit, String move) {
        ...
        if (move.equals("w")) {
            if (!(unit.getY() - 1 < 0)
                    && (gameTiles.getBoardController()[unit.getY() - 1][unit.getX()].getType() == '.')) {
                ...
                if (unit instanceof Player) {
                    ...
                    if (m.getHealth().getAmount() <= 0) {
                        ...
                        gameTiles.getBoardController()[unit.getY() - 1][unit.getX()] = unit;
                        gameTiles.getBoardController()[unit.getY()][unit.getX()] = new Tile('.', unit.getX(),
                                unit.getY());
                        System.out.println(m.getName() + " died." + unit.getName() + "gained " + m.getExperience()
                                + " experience");
            ...
            if (!(unit.getY() + 1 > gameTiles.getBoardController().length)
                    && (gameTiles.getBoardController()[unit.getY() + 1][unit.getX()].getType() == '.')) {
            ...
            if (!(unit.getX() - 1 < 0)
                    && (gameTiles.getBoardController()[unit.getY()][unit.getX() - 1].getType() == '.')) {
            ...
            if (!(unit.getX() + 1 > gameTiles.getBoardController()[0].length)
                    && (gameTiles.getBoardController()[unit.getY()][unit.getX() + 1].getType() == '.')) {
