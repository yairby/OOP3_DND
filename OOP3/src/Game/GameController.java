...
public class GameController {
    ...
    public void play() {
        ...
        File lvl1 = new File("OOP3\\src\\DataAccessLayer\\level1.txt");
        List<String> file = data.readAllLines(lvl1.getAbsolutePath());
        String level1 = "";
        ...
        while (!win && !death) {
            ...
            if (!death) {
                ...
                if (player.getLevel() == 5) {
                    ...
                    File lvl = new File("OOP3\\src\\DataAccessLayer\\level" + player.getLevel() + ".txt");
                    file = data.readAllLines(lvl.getAbsolutePath());
                    level1 = "";
                    for (int u = 0; u < file.size(); u++) {
                        level1 = level1 + file.get(u) + "\n";
                    }
